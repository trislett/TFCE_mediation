...
def getArgumentParser(ap = ap.ArgumentParser(description = DESCRIPTION)):
	...
	stat.add_argument("-cos", "--cosinor",
		nargs='+',
		help="Cosinor model. Input the time variable, and the period. -cos {time} {periodN}",
		...
		if opts.surfaceinputfolder:
			...
			for i, per in enumerate(period):
				...
				write_vertStat_img('Tstat_amplitude_%2.2f' % per,
					...
					mask_rh.shape[0],
					vdensity_rh)
				write_vertStat_img('Tstat_acrophase_%2.2f' % per,
					tACROPHASE[i,:num_vertex_lh],
					outdata_mask_lh,
					affine_mask_lh,
					surface,
					'lh',
				...
				write_vertStat_img('Tstat_acrophase_%2.2f' % per,
					...
					mask_rh.shape[0],
					vdensity_rh)
				write_vertStat_img('amplitude_%2.2f' % per,
					AMPLITUDE[i,:num_vertex_lh],
					outdata_mask_lh,
					affine_mask_lh,
					surface,
					'lh',
				...
				write_vertStat_img('amplitude_%2.2f' % per,
					...
					vdensity_rh,
					TFCE = False)
				write_vertStat_img('acrophase_%2.2f' % per,
					ACROPHASE[i,:num_vertex_lh],
					outdata_mask_lh,
					affine_mask_lh,
					surface,
					'lh',
				...
				write_vertStat_img('acrophase_%2.2f' % per,
					...
					vdensity_rh,
					TFCE = False)
				write_vertStat_img('SE_acrophase_%2.2f' % per,
					SE_ACROPHASE[i,:num_vertex_lh],
					outdata_mask_lh,
					affine_mask_lh,
					surface,
					'lh',
		...
		if opts.volumetricinputs or opts.volumetricinputlist:
			...
			for i, per in enumerate(period):
				write_voxelStat_img('Tstat_amplitude_%2.2f' % per,
					...
					calcTFCE,
					imgext)
				write_voxelStat_img('Tstat_acrophase_%2.2f' % per,
					tACROPHASE[i],
					data_mask,
					mask_index,
					affine_mask,
					calcTFCE,
					imgext)
				write_voxelStat_img('amplitude_%2.2f' % per,
					AMPLITUDE[i],
					data_mask,
					mask_index,
					affine_mask,
					...
					imgext,
					TFCE = False)
				write_voxelStat_img('acrophase_%2.2f' % per,
					ACROPHASE[i],
					data_mask,
					mask_index,
					affine_mask,
					...
					imgext,
					TFCE = False)
				write_voxelStat_img('SE_acrophase_%2.2f' % per,
					SE_ACROPHASE[i],
					data_mask,
					mask_index,
					affine_mask,
