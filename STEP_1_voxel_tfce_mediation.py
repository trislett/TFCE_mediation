...
ap.add_argument("-i", "--input", nargs=3, help="[predictor file] [covariate file] [dependent file]", metavar=('*.csv', '*.csv', '*.csv'), required=True)
ap.add_argument("-m", "--medtype", nargs=1, help="Voxel-wise mediation type", choices=['I','M','Y'], required=True)
ap.add_argument("-t", "--tfce", help="H E Connectivity. Default is 2 1 26.", nargs=3, default=[2,1,26], metavar=('H', 'E', '[6 or 26]'))
opts = ap.parse_args()
