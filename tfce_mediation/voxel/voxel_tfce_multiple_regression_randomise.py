...
from tfce_mediation.stats import tval_int, calcF
from tfce_mediation.tfce import Surface
from tfce_mediation.func import write_perm_maxTFCE_voxel

DESCRIPTION = "Permutation testing for multiple regression with TFCE"
start_time = time()
...
def run(opts):
	...
	#load TFCE fucntion
	calcTFCE = Surface(float(optstfce[0]), float(optstfce[1]), adjac) # H=2, E=2, 26 neighbour connectivity
