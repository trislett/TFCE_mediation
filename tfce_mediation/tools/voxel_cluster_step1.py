...
def run(opts):
	...
	os.system('mkdir -p cluster_results; cluster -i %s -t %1.2f --mm --scalarname="1-p" -o cluster_results/$(basename %s .nii.gz)_clusters > cluster_results/$(basename %s .nii.gz)_results' % (statimage,thresh,statimage,statimage))
