...
#    Load mean_FA_skeleton_mask and all_FA_skeletonised into py_tbss
...
ap = ap.ArgumentParser(description="Load mean_FA_skeleton_mask and all_FA_skeletonised into py_tbss")
ap.add_argument("-i", "--input", nargs=2, help="[4D_image] [Mask]", metavar=('*.nii.gz', '*.nii.gz'), default=['all_FA_skeletonised.nii.gz','mean_FA_skeleton_mask.nii.gz'])
opts = ap.parse_args()
