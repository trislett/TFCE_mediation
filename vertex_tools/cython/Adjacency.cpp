 ...
 * 						numpy.ndarray[float, ndim=1, mode="c"] thresholds):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9Adjacency_1compute, NULL, __pyx_n_s_Adjacency); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_initAdjacency) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
