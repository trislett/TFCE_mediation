...
ap.add_argument("-r", "--range", nargs=2, help="permutation [start] [stop]", metavar=('INT', 'INT'), required=True)
ap.add_argument("-m", "--medtype", nargs=1, help="mediation type [M or Y or I].", choices=['M', 'Y', 'I'], required=True)
opts = ap.parse_args()
